...
def seed_friendships():
    ...
    friendship1 = Friendship(user_id=demo_id, friend_id=aurora_id)
    friendship2 = Friendship(user_id=demo_id, friend_id=justin_id)
    friendship3 = Friendship(user_id=demo_id, friend_id=dmytro_id)
    friendship4 = Friendship(user_id=demo_id, friend_id=will_id)
    friendship5 = Friendship(user_id=demo_id, friend_id=anthony_id)

    # Friendships between aurora and other users
    friendship6 = Friendship(user_id=aurora_id, friend_id=demo_id)
    ...
    friendship11 = Friendship(user_id=justin_id, friend_id=demo_id)
    ...
    friendship14 = Friendship(user_id=justin_id, friend_id=will_id)
    friendship15 = Friendship(user_id=justin_id, friend_id=anthony_id)

    # Friendships between dmytro and other users
    friendship16 = Friendship(user_id=dmytro_id, friend_id=demo_id)
    ...
    friendship20 = Friendship(user_id=dmytro_id, friend_id=anthony_id)

    # Friendships between will and other users
    friendship21 = Friendship(user_id=will_id, friend_id=demo_id)
    friendship22 = Friendship(user_id=will_id, friend_id=aurora_id)
    friendship23 = Friendship(user_id=will_id, friend_id=justin_id)
    friendship24 = Friendship(user_id=will_id, friend_id=dmytro_id)
    friendship25 = Friendship(user_id=will_id, friend_id=anthony_id)
    ...
    friendship29 = Friendship(user_id=anthony_id, friend_id=dmytro_id)
    friendship30 = Friendship(user_id=anthony_id, friend_id=will_id)
